import { version, ref, watchEffect, watch, getCurrentInstance, defineAsyncComponent, defineComponent, useSSRContext, provide, shallowReactive, h, inject, Suspense, nextTick, Fragment, Transition, hasInjectionContext, unref, resolveComponent, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, createApp, effectScope, reactive, getCurrentScope, computed, onErrorCaptured, onServerPrefetch, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, createTextVNode } from 'vue';
import { $ as $fetch$1, h as createError$1, l as defu, m as defuFn, n as klona, o as createDefu, p as parseQuery, q as isEqual, r as createHooks, t as hasProtocol, v as joinURL, w as isScriptProtocol, x as withQuery, y as sanitizeStatusCode, z as withTrailingSlash, A as withoutTrailingSlash, B as toRouteMatcher, C as createRouter$1 } from '../runtime.mjs';
...
import { ssrRenderVNode, ssrRenderSlot, ssrRenderComponent, ssrRenderAttrs, ssrRenderSuspense } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'node:fs';
import 'node:path';
...
const unhead_nybCqpjHDS = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-Bwxjda9x.mjs')
  },
  {
    name: "careers",
    path: "/careers",
    component: () => import('./careers-B8Jyqxf4.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BCbcMAxB.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./projects-DDxwpZWT.mjs')
  }
];
...
const revive_payload_server_Gtaho9omhu = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyIcon = defineAsyncComponent(() => import('./index-aAg93XbI.mjs').then((r) => r["default"] || r.default || r));
...
const slideovers_T79OEqjsjb = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const modals_5ADNUPSV6O = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const colors_oKjCs66Yyk = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugin_server_0bardrRtEM = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  var _a;
...
const plugin_UgdWgy91xe = /* @__PURE__ */ defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
    var _a, _b;
...
const plugins = [
  unhead_nybCqpjHDS,
  plugin,
  revive_payload_server_Gtaho9omhu,
  components_plugin_KR1HBZs4kY,
  slideovers_T79OEqjsjb,
  modals_5ADNUPSV6O,
  colors_oKjCs66Yyk,
  plugin_server_0bardrRtEM,
  plugin_UgdWgy91xe
];
...
_sfc_main$4.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.18.5_vite@5.4.7_vue@3.5.10/node_modules/@nuxt/ui/dist/runtime/components/elements/Link.vue");
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<header${ssrRenderAttrs(mergeProps({ class: "border-b-2 sticky top-0 bg-white overflow-hidden p-2" }, _attrs))}>`);
  _push(ssrRenderComponent(_component_ULink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` KUKLYS &amp; ANTONJUK GBR `);
      } else {
        return [
          createTextVNode(" KUKLYS & ANTONJUK GBR ")
        ];
      }
    }),
    _: 1
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BepuvmwH.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-buDkXDP3.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.13.2_vite@5.4.7/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.13.2_vite@5.4.7/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, __nuxt_component_0$2 as a, useNuxtApp as b, useRuntimeConfig as c, useAppConfig as d, entry$1 as default, appConfig as e, __nuxt_component_0$1 as f, get as g, getNuxtLinkProps as h, asyncDataDefaults as i, createError as j, mergeConfig as m, nuxtLinkProps as n, omit as o, useHead as u };
